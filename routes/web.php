...
Route::post('/paiement/cinetpay/notify', [PaiementController::class, 'notify'])->name('paiement.notify'); // callback serveur
Route::get('/paiement/cinetpay/retour', [PaiementController::class, 'retour'])->name('paiement.retour');  // retour client

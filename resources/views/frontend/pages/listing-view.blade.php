                ...
                <div class="row justify-content-center">
                    <div class="col-12 text-center text-white">
                        ...
                        <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item" data-=""><a  href="{{ url('/') }}" > Accueil </a></li>
                    ...
                    <div class="listing_details_text">
                        <div class="listing_det_header">
                            ...
                            <div class="listing_det_header_text">
                                <h6>{{ $listing->title }}</h6>
                                <p class="host_name">Proposé par <a href="agent_public_profile.html">{{ $listing->user->name }}</a></p>
                                <p class="rating">
                                    @for ($i = 1; $i <= 5; $i++)
                                ...
                                <ul>
                                    ...
                                    <li><a href="#"><i class="far fa-check"></i> Vérifié</a></li>
                                    @endif
                                    @if ($listing->is_featured)
                                    <li><a href="#"><i class="far fa-star"></i> Vedette</a></li>
                                    @endif
                                    <li><a href="#"><i class="fal fa-heart"></i> Ajouter aux favoris</a></li>
                                    <li><a href="#"><i class="fal fa-eye"></i> {{ $listing->views }}</a></li>
                                    @if ($openStatus == 'open')
                                        <li><a href="javascript:;">Ouvert</a></li>
                                    @elseif ($openStatus == 'close')
                                    <li><a href="javascript:;">Fermé</a></li>
                                    @endif
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="wsus__listing_review">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="blog_single_input">
                                            <textarea cols="3" rows="5" placeholder="Commentaire" name="review"></textarea>
                                            <button type="submit" class="read_btn">Publier l'avis</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            @guest
                                <div class="alert alert-warning">
                                    Veuillez vous <a href="{{ route('login') }}">connecter</a> pour publier un avis.
                                </div>
                            @endguest
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="listing_det_side_contact">
                                    ...
                                    <div class="alert alert-success mt-4 text-center d-none message-alert"><a href="{{ route('user.messages') }}">Cliquez ici</a> pour accéder à votre messagerie.</div>
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="listing_det_side_contact">
                                    <h5>Revendiquer cette annonce</h5>
                                    <button type="submit" class="read_btn" data-bs-toggle="modal" data-bs-target="#claimModal">Revendiquer</button>
                                </div>
                            </div>
                                ...
                                <div class="listing_det_side_list">
                                    ...
                                    <a href="{{ route('listing.show', $smellerListing->slug) }}" class="sidebar_blog_single">
                                        ...
                                        <div class="sidebar_blog_text">
                                            ...
                                            <p> <span>{{ date('m d Y', strtotime($smellerListing->created_at)) }} </span> 2 commentaires </p>
                                        </div>
                                    </a>
                                    @endforeach
        ...
        <div class="modal fade" id="claimModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <button type="button" class="btn-close popup_close" data-bs-dismiss="modal" aria-label="Fermer"><i
                            class="far fa-times"></i></button>
                    <div class="modal-body listing_det_side_contact" style="box-shadow: none">
                        <h5 class="mb-3">Formulaire de revendication</h5>
                            <form action="{{ route('submit-claim') }}" method="POST">
                                @csrf
                                <input type="hidden" name="listing_id" value="{{ $listing->id }}">
                                <input type="text" placeholder="Nom*" name="name" value="{{ auth()->user()?->name }}">
                                <input type="email" placeholder="Email*" name="email" value="{{ auth()->user()?->email }}">
                                <textarea cols="3" rows="5" placeholder="Revendication*" name="claim"></textarea>

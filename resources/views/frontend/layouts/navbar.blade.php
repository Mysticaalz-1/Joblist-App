            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-5">
                    <div class="wsus__topbar_right">
                        @auth
                            <a href="{{ route('user.dashboard') }}"><i class="fas fa-user"></i> Tableau de bord</a>
                        @endauth
                        @guest
    ...
    <nav class="navbar navbar-expand-lg main_menu">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="user_btn" href="{{ route('user.listing.create') }}"><i class="far fa-plus"></i> Ajouter une annonce</a>
            </div>
        </div>
    </nav>
    <!--==========================

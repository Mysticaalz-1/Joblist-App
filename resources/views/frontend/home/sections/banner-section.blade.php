            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-5 col-lg-5">
                    <form action="{{ route('listings') }}" method="GET">
                        <h3>Trouvez Votre Bien Idéal</h3>
                        <div class="wsus__search_area">
                            <input type="text" placeholder="Type de bien recherché ?" name="search">
                        </div>
                        <div class="wsus__search_area">
                        ...
                        <div class="wsus__search_area">
                            <select class="select_2" name="location" >
                                <option value="">Localisation (Province, ville)</option>
                        ...
                        <div class="wsus__search_area m-0">
                            <button type="submit" class="read_btn">Rechercher</button>
                        </div>
                    </form>
                </div>
            </div>
